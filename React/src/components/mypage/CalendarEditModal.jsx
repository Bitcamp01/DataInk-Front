        ...
        if (selectedCalendar) {
            ...
            dispatch(updateCalendar({ id: selectedCalendar.id, calendarName, color }))
                ...
                .then((updatedCalendar) => {
                    ...
                    const updatedCalendars = calendarOptions.map((calendars) =>
                        calendars.id === selectedCalendar.id ? updatedCalendar : calendars
                    );
    ...
    const handleDeleteCalendar = () => {
        if (selectedCalendar) {
            dispatch(deleteCalendar(selectedCalendar.id))
                .unwrap()
                .then(() => {
                    setCalendarOptions(calendarOptions.filter(calendars => calendars.id !== selectedCalendar.id));
                    onRequestClose();
                })
                .catch((error) => {
