...
const ItemStructure = () => {
    ...
    const getItem= async ()=>{
        ...
        try {
            const response=await axios.get(`https://223.130.134.24:9090/item/${itemId}`,{
                headers: {
    ...
    const handleSave = async () => {
        try {
            ...
            if (itemId == 0) {
                ...
                const response = await axios.post("https://223.130.134.24:9090/projects/itemcreate",payload,{
                    headers: {
                        'Authorization': `Bearer ${sessionStorage.getItem('ACCESS_TOKEN')}`
                    }
                })
                ...
                const response = await axios.post("https://223.130.134.24:9090/item/update",payload,{
